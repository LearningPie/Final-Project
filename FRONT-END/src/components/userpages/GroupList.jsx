...
//     const response = await axios.get(`http://localhost:8080/getAllGroupsInfo`);
//     //alert(response.data);
...
//       </div>
//       <Sidebar></Sidebar>
//       <div class="bg-warning " style={{ height: "100rem" }}>
...
//                         ))
//                       ) : (
//                         <h2 className="text-center m-5 p-5">No Questions</h2>
//                       )}
//                     </tbody>
//                   </table>
//                 </div>
